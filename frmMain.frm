...
frmList.endTheList
minList = True
frmList.mnuPlaylist.Checked = False
End If
End Sub
...
Equalizer.endMe
frmList.mnuEqualizer.Checked = False
End If
End Sub
...
Me.Picture = LoadPicture(App.Path & "\" & "main.jpg")
ElseIf txtLoad.Text = "blue" Then
Me.Picture = LoadPicture(App.Path & "\" & "mainblue.jpg")
ElseIf txtLoad.Text = "L" Then
Me.Picture = LoadPicture(App.Path & "\" & "mainL.jpg")
ElseIf txtLoad.Text = "red" Then
Me.Picture = LoadPicture(App.Path & "\" & "mainred.jpg")
ElseIf txtLoad.Text = "Iron" Then
Me.Picture = LoadPicture(App.Path & "\" & "mainIron.jpg")
