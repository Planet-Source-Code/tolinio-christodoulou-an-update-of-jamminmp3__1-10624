...
Me.Picture = LoadPicture(App.Path & "\" & "main2.jpg")
ElseIf txtLoad.Text = "blue" Then
Me.Picture = LoadPicture(App.Path & "\" & "main2blue.jpg")
ElseIf txtLoad.Text = "L" Then
Me.Picture = LoadPicture(App.Path & "\" & "main2L.jpg")
ElseIf txtLoad.Text = "red" Then
Me.Picture = LoadPicture(App.Path & "\" & "main2red.jpg")
ElseIf txtLoad.Text = "Iron" Then
Me.Picture = LoadPicture(App.Path & "\" & "main2Iron.jpg")
