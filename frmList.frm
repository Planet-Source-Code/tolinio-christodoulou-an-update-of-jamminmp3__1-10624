...
'Launch default mail program to send an email message
...
'==============ini file
List_Load List1, App.Path & "\" & "load1.lst"
List_Load List2, App.Path & "\" & "load1.lst"
...
Me.Picture = LoadPicture(App.Path & "\" & "main3.jpg")
ElseIf txtLoad.Text = "blue" Then
Me.Picture = LoadPicture(App.Path & "\" & "main3blue.jpg")
ElseIf txtLoad.Text = "L" Then
Me.Picture = LoadPicture(App.Path & "\" & "main3L.jpg")
ElseIf txtLoad.Text = "red" Then
Me.Picture = LoadPicture(App.Path & "\" & "main3red.jpg")
ElseIf txtLoad.Text = "Iron" Then
Me.Picture = LoadPicture(App.Path & "\" & "main3Iron.jpg")
...
savetheSec
List_Save List2, App.Path & "\" & "load1.lst"

End Sub

Private Sub savetheSec()
List_Save List1, App.Path & "\" & "load2.lst"
...
Private Sub mnuEqualizer_Click()
EqCount = EqCount + 1
If EqCount Mod 2 = 0 Then
mnuEqualizer.Checked = True
ElseIf EqCount Mod 2 <> 0 Then
mnuEqualizer.Checked = False
End If


If mnuEqualizer.Checked = True Then
Equalizer.Show
frmMain.Check2.Value = 1
ElseIf mnuEqualizer.Checked = False Then
Equalizer.endMe
...
Private Sub mnuFile2About_Click()
frmAbout.Show
End Sub

Private Sub mnuFile2Contact_Click()
    ShellExecute hwnd, "open", "mailto:tolisc@hotmail.com", vbNullString, vbNullString, SW_SHOW

End Sub

Private Sub mnuFile2Exit_Click()
frmList.endTheList
Equalizer.endMe
End
End Sub

Private Sub mnuFile3PlayDir_Click()
Form1.Show
...
Private Sub mnuFileClearPlaylist_Click()
List1.Clear
List2.Clear
...
Private Sub mnuFileGetMp3s_Click()
Form2.Show
End Sub
...
Private Sub mnuFilePlaylistInfo_Click()
frmListEntry.Show
frmListEntry.Text1.Text = List2.Text
End Sub
...
Private Sub mnuFileWeb_Click()
ShellExecute hwnd, "open", "http://www.planetsourcecode.com", vbNullString, vbNullString, conSwNormal
End Sub

Private Sub mnuGetMp3s_Click()
Form2.Show
End Sub
...
chCount = chCount + 1
If chCount Mod 2 = 0 Then
mnuPlaylist.Checked = True
ElseIf chCount Mod 2 <> 0 Then
...
ElseIf mnuPlaylist.Checked = False Then
frmList.endTheList
frmMain.Check1.Value = 0
End If
End Sub
